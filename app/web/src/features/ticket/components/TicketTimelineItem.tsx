...
> = {
  STATUS_CHANGED: {
    ...
    dotClass:
      'text-blue-600 border border-blue-300 dark:text-blue-400 dark:border-blue-800',
    label: 'Status changed',
  },
  PRIORITY_CHANGED: {
    icon: <AlertTriangle size={14} strokeWidth={1.8} />,
    dotClass:
      'text-amber-600 border border-amber-300 dark:text-amber-400 dark:border-amber-800',
    label: 'Priority updated',
  },
  ESCALATED: {
    icon: <AlertTriangle size={14} strokeWidth={2} />,
    dotClass:
      'text-rose-600 border border-rose-300 dark:text-rose-400 dark:border-rose-800',
  ...
  QUEUE_CHANGED: {
    icon: <ArrowRightLeft size={14} strokeWidth={1.8} />,
    dotClass:
      'text-teal-600 border border-teal-300 dark:text-teal-400 dark:border-teal-800',
    label: 'Queue changed',
  },
  GROUP_CHANGED: {
    icon: <Users size={14} strokeWidth={1.8} />,
    dotClass:
      'text-indigo-600 border border-indigo-300 dark:text-indigo-400 dark:border-indigo-800',
    label: 'Group changed',
  },
  NOTE_ADDED: {
    icon: <Clock size={14} strokeWidth={1.5} />,
    dotClass:
      'text-slate-500 border border-stone-300 dark:text-slate-400 dark:border-slate-700',
    label: 'Note added',
  },
};
  ...
  return (
    <div className="flex gap-3">
      ...
      <div className="flex flex-col items-center">
        ...
        {!isLast && (
          <div className="bg-border/60 mt-1 min-h-[20px] w-px flex-1" />
        )}
      </div>
