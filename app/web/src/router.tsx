...
const TicketsPage = lazy(() => import("./features/ticket/components/TicketsPage"));
const TicketDetailPage = lazy(() => import("./features/ticket/components/TicketDetailPage"));
const QueuePage = lazy(() => import("./features/queueGroups/components/QueuePage"));
const QueueDetailPage = lazy(() => import("./features/queueGroups/components/QueueDetailPage"));
...
const MembersPage = lazy(() => import("./features/members/components/MemberPage"));
const CustomerPage = lazy(() => import("./features/customer/components/CustomerPage"));

const SettingsLayout = lazy(() => import("./features/setting/pages/SettingLayout"));
const ProfileTab = lazy(() => import("./features/setting/components/ProfileTab"));
const SecurityTab = lazy(() => import("./features/setting/components/tabs/SecurityTab"));
const OrganizationTab = lazy(() => import("./features/setting/components/tabs/OrganizationTab"));
const EmailTab = lazy(() => import("./features/setting/components/tabs/GeneralTab"));
